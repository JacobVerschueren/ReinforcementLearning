...
class LearningStrategy(abc.ABC):
    ...
    def __init__(self, mdp: MarkovDecisionProcess, learning_rate, decay_rate, random_probability, epsilon_max = 1.0, epsilon_min = 0.01):
        self.learning_rate = learning_rate # alpha
        self.decay_rate = decay_rate # lambda
        self.random_probability = random_probability # epsilon
